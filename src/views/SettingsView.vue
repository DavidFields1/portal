      ...
      <Card>
        ...
        <CardContent class="space-y-4">
          ...
          <div class="grid gap-2">
            ...
            <Textarea id="bio" v-model="userBio" placeholder="Cuéntanos un poco sobre ti..." :disabled="isLoading" />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent class="space-y-6">
          <div class="flex items-center justify-between space-x-2 rounded-md border p-4">
            ...
            <Switch id="dark-mode" v-model="darkMode" :disabled="isLoading" />
          </div>
      ...
      <Card>
        ...
        <CardContent class="space-y-6">
          <div class="flex items-center justify-between space-x-2 rounded-md border p-4">
            ...
            <Switch id="email-notifications" :checked="emailNotifications" @update:checked="emailNotifications = $event"
              :disabled="isLoading" />
          </div>
          <div class="flex items-center justify-between space-x-2 rounded-md border p-4">
            ...
            <Switch id="push-notifications" :checked="pushNotifications" @update:checked="pushNotifications = $event"
              :disabled="isLoading" />
          </div>
        </CardContent>
      </Card>
