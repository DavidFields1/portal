	...
	<div class="container mx-auto py-6 md:py-10">
		...
		<div class="flex justify-between items-center">
			...
			<div class="flex items-center gap-2 mb-3">
				<Button
					:variant="selectedTable === 'users' ? 'default' : 'outline'"
				...
				<Button
					:variant="selectedTable === 'providers' ? 'default' : 'outline'"
					@click="selectedTable = 'providers'"
					:class="
											...
											<TableCell class="text-right">
												<DropdownMenu>
													...
													<DropdownMenuContent align="end">
														...
														<DropdownMenuItem
															@click="toggleProviderStatus(prov.id)"
														>
