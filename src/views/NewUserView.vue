        ...
        <CardContent>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="flex flex-col gap-2">
              ...
              <Input id="name" v-model="newUser.name" placeholder="Ej: John Doe" required />
            </div>

            <!-- Campo Email -->
            <div class="flex flex-col gap-2">
              <Label for="email">Correo Electrónico</Label>
              <Input id="email" type="email" v-model="newUser.email" placeholder="Ej: john.doe@example.com" required />
            </div>
