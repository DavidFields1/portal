				...
				<Card>
					...
					<CardContent class="mt-4">
						...
						<div v-if="currentStepIndex === 0" class="space-y-6">
							<div>
								<Label for="pdf-upload" class="block mb-2 font-semibold"
									>Archivo PDF de la factura</Label
								>
								<div
							...
							<div>
								<Label for="xml-upload" class="block mb-2 font-semibold"
									>Archivo XML de la factura</Label
								>
								<div
									class="border-2 border-dashed border-muted-foreground/25 rounded-lg p-6 text-center hover:border-muted-foreground/50 transition-colors"
								>
